define(["org/eclipse/edt/rui/widgets/GridLayout", "eglx/ui/rui/eze$$View"],function(){
	...
	egl.defineRUIHandler("client.common", "Learn", {
		"eze$$fileName" : "client/common/Learn.egl",
		"eze$$runtimePropertiesFile" : "client/common/Learn",
			...
			"eze$$clone": function() {
				var ezert$$1 = this;
				var ezert$$2 = new egl.client.common.Learn();
