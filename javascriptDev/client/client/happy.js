define(["org/eclipse/edt/rui/widgets/Box", "org/eclipse/edt/rui/widgets/Image", "eglx/ui/rui/eze$$View", "org/eclipse/edt/rui/widgets/GridLayoutData", "org/eclipse/edt/rui/widgets/GridLayout", "org/eclipse/edt/rui/widgets/TextLabel"],function(){
	...
	egl.defineRUIHandler("client.client", "happy", {
		"eze$$fileName" : "client/client/happy.egl",
		"eze$$runtimePropertiesFile" : "client/client/happy",
			...
			"eze$$setInitial": function() {
				try { egl.enter("<init>",this,arguments);
					...
					egl.atLine(this.eze$$fileName,19,621,14, this);
					this.TextLabel.setText("\u5feb\u4e50\u7684\u5bb6\u56ed");
					...
					egl.atLine(this.eze$$fileName,30,1335,16, this);
					this.TextLabel2.setText("\u4e00\u3001\u770b\u56fe\u5199\u6570\u3002");
					egl.atLine(this.eze$$fileName,31,1358,13, this);
					this.TextLabel2.setFont("\u5fae\u8f6f\u96c5\u9ed1");
					egl.atLine(this.eze$$fileName,32,1378,15, this);
					this.TextLabel2.setFontSize("18");
					var eze$LNNTemp6 = null;
					{
						var eze$SettingTarget1 = new egl.org.eclipse.edt.rui.widgets.GridLayoutData();
						egl.atLine(this.eze$$fileName,33,1423,41, this);
						eze$SettingTarget1 = egl.eglx.lang.AnyValue.ezeCopyTo(new egl.org.eclipse.edt.rui.widgets.GridLayoutData(), eze$SettingTarget1);
						egl.atLine(this.eze$$fileName,33,1443,7, this);
						eze$SettingTarget1.row = 2;
						egl.atLine(this.eze$$fileName,33,1452,10, this);
						eze$SettingTarget1.column = 1;
						egl.atLine(this.eze$$fileName,33,1423,41, this);
						eze$LNNTemp6 = egl.eglx.lang.AnyValue.ezeCopyTo(eze$SettingTarget1, eze$LNNTemp6);
					}
					egl.atLine(this.eze$$fileName,33,1410,54, this);
					...
					egl.atLine(this.eze$$fileName,33,1466,9, this);
					this.Box.setPadding(8);
					egl.atLine(this.eze$$fileName,34,1482,20, this);
					...
					egl.atLine(this.eze$$fileName,36,1528,38, this);
					this.Image.setSrc("E:\\workspace\\pictures\\9.jpg");
					var eze$LNNTemp7 = null;
					{
						var eze$SettingTarget1 = new egl.org.eclipse.edt.rui.widgets.GridLayoutData();
						egl.atLine(this.eze$$fileName,38,1615,41, this);
						eze$SettingTarget1 = egl.eglx.lang.AnyValue.ezeCopyTo(new egl.org.eclipse.edt.rui.widgets.GridLayoutData(), eze$SettingTarget1);
						egl.atLine(this.eze$$fileName,38,1635,7, this);
						eze$SettingTarget1.row = 3;
						egl.atLine(this.eze$$fileName,38,1644,10, this);
						eze$SettingTarget1.column = 1;
						egl.atLine(this.eze$$fileName,38,1615,41, this);
						eze$LNNTemp7 = egl.eglx.lang.AnyValue.ezeCopyTo(eze$SettingTarget1, eze$LNNTemp7);
					}
					egl.atLine(this.eze$$fileName,38,1602,54, this);
					...
					egl.atLine(this.eze$$fileName,38,1658,15, this);
					this.GridLayout2.setCellPadding(4);
					egl.atLine(this.eze$$fileName,38,1675,8, this);
					this.GridLayout2.setRows(2);
					egl.atLine(this.eze$$fileName,38,1685,11, this);
					this.GridLayout2.setColumns(1);
					egl.atLine(this.eze$$fileName,39,1703,31, this);
					...
					{
						var eze$SettingTarget1 = new egl.org.eclipse.edt.rui.widgets.GridLayoutData();
						egl.atLine(this.eze$$fileName,40,1777,41, this);
						eze$SettingTarget1 = egl.eglx.lang.AnyValue.ezeCopyTo(new egl.org.eclipse.edt.rui.widgets.GridLayoutData(), eze$SettingTarget1);
						egl.atLine(this.eze$$fileName,40,1797,7, this);
						eze$SettingTarget1.row = 1;
						egl.atLine(this.eze$$fileName,40,1806,10, this);
						eze$SettingTarget1.column = 1;
						egl.atLine(this.eze$$fileName,40,1777,41, this);
						eze$LNNTemp8 = egl.eglx.lang.AnyValue.ezeCopyTo(eze$SettingTarget1, eze$LNNTemp8);
					}
					egl.atLine(this.eze$$fileName,40,1764,54, this);
					...
					egl.atLine(this.eze$$fileName,40,1820,22, this);
					this.TextLabel3.setText("\u4e8c\u3001\u628a\u540c\u6837\u591a\u7684\u7528\u7ebf\u8fde\u8d77\u6765\u3002");
					...
					egl.atLine(this.eze$$fileName,44,1974,21, this);
					...
					egl.atLine(this.eze$$fileName,46,2022,39, this);
					this.Image1.setSrc("E:\\workspace\\pictures\\10.jpg");
					var eze$LNNTemp10 = null;
					{
						var eze$SettingTarget1 = new egl.org.eclipse.edt.rui.widgets.GridLayoutData();
						egl.atLine(this.eze$$fileName,48,2110,41, this);
						eze$SettingTarget1 = egl.eglx.lang.AnyValue.ezeCopyTo(new egl.org.eclipse.edt.rui.widgets.GridLayoutData(), eze$SettingTarget1);
						egl.atLine(this.eze$$fileName,48,2130,7, this);
						eze$SettingTarget1.row = 4;
						egl.atLine(this.eze$$fileName,48,2139,10, this);
						eze$SettingTarget1.column = 1;
						egl.atLine(this.eze$$fileName,48,2110,41, this);
						eze$LNNTemp10 = egl.eglx.lang.AnyValue.ezeCopyTo(eze$SettingTarget1, eze$LNNTemp10);
					}
					egl.atLine(this.eze$$fileName,48,2097,54, this);
					...
					egl.atLine(this.eze$$fileName,48,2153,15, this);
					this.GridLayout4.setCellPadding(4);
					egl.atLine(this.eze$$fileName,48,2170,8, this);
					this.GridLayout4.setRows(2);
					egl.atLine(this.eze$$fileName,48,2180,11, this);
					this.GridLayout4.setColumns(1);
					egl.atLine(this.eze$$fileName,49,2198,31, this);
					...
					{
						var eze$SettingTarget1 = new egl.org.eclipse.edt.rui.widgets.GridLayoutData();
						egl.atLine(this.eze$$fileName,50,2272,41, this);
						eze$SettingTarget1 = egl.eglx.lang.AnyValue.ezeCopyTo(new egl.org.eclipse.edt.rui.widgets.GridLayoutData(), eze$SettingTarget1);
						egl.atLine(this.eze$$fileName,50,2292,7, this);
						eze$SettingTarget1.row = 1;
						egl.atLine(this.eze$$fileName,50,2301,10, this);
						eze$SettingTarget1.column = 1;
						egl.atLine(this.eze$$fileName,50,2272,41, this);
						eze$LNNTemp11 = egl.eglx.lang.AnyValue.ezeCopyTo(eze$SettingTarget1, eze$LNNTemp11);
					}
					egl.atLine(this.eze$$fileName,50,2259,54, this);
					...
					egl.atLine(this.eze$$fileName,50,2315,38, this);
					this.TextLabel6.setText("\u4e09\u3001\u54ea\u4e2a\u5708\u91cc\u7269\u54c1\u7684\u6570\u76ee\u4e0e\u5176\u5b83\u5708\u91cc\u7684\u4e0d\u4e00\u6837\uff0c\u8bf7\u5728\uff08\uff09\u91cc\u6253\u221a\u3002");
					egl.atLine(this.eze$$fileName,51,2360,13, this);
					this.TextLabel6.setFont("\u5fae\u8f6f\u96c5\u9ed1");
					egl.atLine(this.eze$$fileName,52,2380,15, this);
					this.TextLabel6.setFontSize("18");
					var eze$LNNTemp12 = null;
					{
						var eze$SettingTarget1 = new egl.org.eclipse.edt.rui.widgets.GridLayoutData();
						egl.atLine(this.eze$$fileName,53,2426,41, this);
						eze$SettingTarget1 = egl.eglx.lang.AnyValue.ezeCopyTo(new egl.org.eclipse.edt.rui.widgets.GridLayoutData(), eze$SettingTarget1);
						egl.atLine(this.eze$$fileName,53,2446,7, this);
						eze$SettingTarget1.row = 2;
						egl.atLine(this.eze$$fileName,53,2455,10, this);
						eze$SettingTarget1.column = 1;
						egl.atLine(this.eze$$fileName,53,2426,41, this);
						eze$LNNTemp12 = egl.eglx.lang.AnyValue.ezeCopyTo(eze$SettingTarget1, eze$LNNTemp12);
					}
					egl.atLine(this.eze$$fileName,53,2413,54, this);
					...
					egl.atLine(this.eze$$fileName,53,2469,9, this);
					this.Box2.setPadding(8);
					egl.atLine(this.eze$$fileName,54,2485,21, this);
					...
					egl.atLine(this.eze$$fileName,56,2533,39, this);
					this.Image2.setSrc("E:\\workspace\\pictures\\11.jpg");
			...
			"eze$$clone": function() {
				var ezert$$1 = this;
				var ezert$$2 = new egl.client.client.happy();
			...
			"eze$$getAnnotations": function() {
				if(this.annotations === undefined){
					this.annotations = {};
					this.annotations["XMLRootElement"] = new egl.eglx.xml.binding.annotation.XMLRootElement("happy", null, false);
				}
			...
			"start": function() {
				try { egl.enter("start",this,arguments);
					egl.atLine(this.eze$$fileName,59,2585,24, this);
					if (!egl.debugg) egl.leave();
				} finally {
					if (!egl.debugg){
					} else { egl.leave(); }
