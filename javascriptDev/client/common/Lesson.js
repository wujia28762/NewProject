	...
	egl.defineClass('client.common', "Lesson", "egl.jsrt", "Record", {
		"eze$$fileName" : "client/common/lessonRec.egl",
			...
			"eze$$getName": function() {
				return "client.common.Lesson";
			}
			,
			"eze$$getChildVariables": function() {
				var eze$$parent = this;
				return [
				{name: "lesson_id", value : eze$$parent.lesson_id, type : "eglx.lang.EInt", jsName : "lesson_id"},
				{name: "lessonname", value : eze$$parent.lessonname, type : "eglx.lang.EString(100)", jsName : "lessonname"},
				{name: "coursecom", value : eze$$parent.coursecom, type : "eglx.lang.EString(255)", jsName : "coursecom"},
				{name: "_url", value : eze$$parent._url, type : "eglx.lang.EString(255)", jsName : "_url"}
				];
			}
		}
	);
