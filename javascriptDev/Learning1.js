define(["org/eclipse/edt/rui/widgets/GridLayout", "eglx/ui/rui/eze$$View"],function(){
	...
	egl.defineRUIHandler("", "Learning1", {
		"eze$$fileName" : "EGLSource/Learning1.egl",
		"eze$$runtimePropertiesFile" : "Learning1",
			...
			"eze$$setInitial": function() {
				try { egl.enter("<init>",this,arguments);
					this.eze$$setEmpty();
					egl.atLine(this.eze$$fileName,12,261,11, this);
					this.ui.setColumns(3);
					egl.atLine(this.eze$$fileName,12,274,8, this);
					this.ui.setRows(4);
					egl.atLine(this.eze$$fileName,12,284,15, this);
					this.ui.setCellPadding(4);
					egl.atLine(this.eze$$fileName,12,301,12, this);
					this.ui.setChildren((function() { var eze$Temp1 = []; eze$Temp1.setType("[eglx.ui.rui.Widget");
						for (var i = 0; i < 0; i++) {
						eze$Temp1[i] = new egl.eglx.ui.rui.Widget();}
					return eze$Temp1;})());
					egl.atLine(this.eze$$fileName,9,136,28, this);
			...
			"start": function() {
				try { egl.enter("start",this,arguments);
					egl.atLine(this.eze$$fileName,14,321,24, this);
					if (!egl.debugg) egl.leave();
				} finally {
					if (!egl.debugg){
					} else { egl.leave(); }
