define(["eglx/ui/rui/eze$$View", "org/eclipse/edt/rui/widgets/GridLayout"],function(){
	...
	egl.defineRUIHandler("client.client", "Text2", {
		"eze$$fileName" : "client/client/Text2.egl",
		"eze$$runtimePropertiesFile" : "client/client/Text2",
			...
			"eze$$clone": function() {
				var ezert$$1 = this;
				var ezert$$2 = new egl.client.client.Text2();
			...
			"eze$$getAnnotations": function() {
				if(this.annotations === undefined){
					this.annotations = {};
					this.annotations["XMLRootElement"] = new egl.eglx.xml.binding.annotation.XMLRootElement("Text2", null, false);
				}
