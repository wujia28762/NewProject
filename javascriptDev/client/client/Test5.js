define(["eglx/ui/rui/eze$$View", "org/eclipse/edt/rui/widgets/GridLayout"],function(){
	...
	egl.defineRUIHandler("client.client", "Test5", {
		"eze$$fileName" : "client/client/Test5.egl",
		"eze$$runtimePropertiesFile" : "client/client/Test5",
			...
			"eze$$setInitial": function() {
				try { egl.enter("<init>",this,arguments);
					this.eze$$setEmpty();
					egl.atLine(this.eze$$fileName,14,281,11, this);
					this.ui.setColumns(3);
					egl.atLine(this.eze$$fileName,14,294,8, this);
					this.ui.setRows(4);
					egl.atLine(this.eze$$fileName,14,304,15, this);
					this.ui.setCellPadding(4);
					egl.atLine(this.eze$$fileName,14,321,12, this);
					this.ui.setChildren((function() { var eze$Temp1 = []; eze$Temp1.setType("[eglx.ui.rui.Widget");
						for (var i = 0; i < 0; i++) {
						eze$Temp1[i] = new egl.eglx.ui.rui.Widget();}
					return eze$Temp1;})());
					egl.atLine(this.eze$$fileName,11,156,28, this);
			...
			"eze$$clone": function() {
				var ezert$$1 = this;
				var ezert$$2 = new egl.client.client.Test5();
			...
			"eze$$getAnnotations": function() {
				if(this.annotations === undefined){
					this.annotations = {};
					this.annotations["XMLRootElement"] = new egl.eglx.xml.binding.annotation.XMLRootElement("Test5", null, false);
				}
			...
			"start": function() {
				try { egl.enter("start",this,arguments);
					egl.atLine(this.eze$$fileName,16,341,24, this);
					if (!egl.debugg) egl.leave();
				} finally {
					if (!egl.debugg){
					} else { egl.leave(); }
